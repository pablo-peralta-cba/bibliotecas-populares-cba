...
router
  ...
  .post(
    ...
    cuotaMiddleware,
    validateBiblio,
    catchAsync(bibliotecas.crearBiblio)
  );
...
router
  ...
  .put(
    ...
    cuotaMiddleware,
    validateBiblio,
    catchAsync(bibliotecas.editarBiblio)
  )
...
router.get(
  ...
  esAutor,
  verificarEmail,
  catchAsync(bibliotecas.editForm)
);

router
  .route('/:id/libros')
  .get(catchAsync(bibliotecas.librosPorBiblio))
  .post(
    estaLogueado,
    esAutor,
    verificarEmail,
    validateLibro,
    catchAsync(libros.crearLibro)
  );
...
router.get(
  ...
  estaLogueado,
  verificarEmail,
  catchAsync(libros.nuevoLibroForm)
);

router.get(
  '/:id/libros/:libroId/editar',
  estaLogueado,
  verificarEmail,
  catchAsync(libros.editarLibroForm)
);

router
  .route('/:id/libros/:libroId')
  ...
  .put(
    ...
    verificarEmail,
    validateLibro,
    catchAsync(libros.editarLibro)
  )
  .delete(
    estaLogueado,
    esAutor,
    verificarEmail,
    catchAsync(libros.borrarLibro)
  );
