...
const { estaLogueado, validateBiblio, validateLibro, esAutor, isVerified } = require('../middleware');
...
router.route('/')
    ...
    .post(estaLogueado, isVerified, upload.array('image', 10), validateBiblio, catchAsync(bibliotecas.crearBiblio)); 
...
router.route('/:id')
    ...
    .put(estaLogueado, isVerified, esAutor, upload.array('image', 10), validateBiblio, catchAsync(bibliotecas.editarBiblio)) 
